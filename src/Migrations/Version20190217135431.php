 ...
 */
final class Version20190217135431 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE log ADD CONSTRAINT FK_8F3F68C5162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id)');
